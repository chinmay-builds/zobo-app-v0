...
class GoogleCalendarService:
        ...
        try:
            ...
            if not self.credentials or not self.credentials.valid:
                if self.credentials and self.credentials.expired and self.credentials.refresh_token:
                    ...
                    logging.warning("Google Calendar credentials not available or invalid")
                    return False
    ...
    def find_free_slots(self, duration_minutes, start_date=None, end_date=None, working_hours=(9, 17)):
    ...
    def smart_schedule_event(self, summary, duration_minutes, preferred_times=None, description="", location=""):
