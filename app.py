    ...
    def initialize_client(self):
        ...
        try:
            if self.api_key:
                ...
                logging.warning("Gemini API key not configured. Live voice features will be disabled.")
...
def voice_api_status():
    ...
    try:
        configured = voice_client is not None
        ...
        return jsonify({
            ...
            'message': 'Gemini Live API is ready' if configured else 'Gemini Live API not configured',
